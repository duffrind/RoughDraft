...
It does seem like there is some association between the magnitude of the errors and the variables GANGHATE, srs_to_police, and Incpol--all of the non-categorical variables.

This means that we should choose the Kolmogorov-Smirnov test for normality of the errors rather than the Shapiro-Wilkes test.
